  ...
  return (
    <section className="flex flex-col gap-6 mx-auto max-w-[500px]">
      <Link href="/find-my-plate" className="flex-1">
        <Card className="bg-foreground text-background transition-shadow hover:shadow-xl">
          <CardHeader>
            <h2>Find my plate</h2>
          </CardHeader>
          <CardBody>
      ...
      <Link href="/submit-details" className="flex-1 transition-shadow hover:shadow">
        <Card className="bg-foreground text-background transition-shadow hover:shadow-xl">
          <CardHeader>
